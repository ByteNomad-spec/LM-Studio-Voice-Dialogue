...
class VoiceAssistantBackend:
    ...
    def generate_summary(self) -> None:
        summary_prompt = (
            "На основе данных из наших сообщений, создай или обнови сжатое структурированное резюме всей ключевой информации обо мне. "
            ...
            "2. Семья: члены семьи, близкие родственники, имена, возраст, место проживания, важные детали, события и воспоминания. "
