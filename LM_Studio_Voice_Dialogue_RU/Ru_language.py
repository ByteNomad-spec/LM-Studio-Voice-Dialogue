...
class VoiceAssistantBackend:
    ...
    def generate_summary(self) -> None:
        summary_prompt = (
            ...
            "2. Семья: члены семьи, родственники, имена, возраст, место проживания, важные детали, события и воспоминания. "
            ...
            "9. Важно: не выдумывай информацию если она остутствует. "
            "Это резюме предназначено для твоей долговременной памяти и не должно обсуждаться в процессе нашего общения."
        )
